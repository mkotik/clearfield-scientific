  ...
  return (
    <section id="showcase" ref={sectionRef} style={{ position: 'relative', height: '300vh', background: '#0B2545' }}>
      <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden' }}>
          ...
          <div style={{ width: '100%', maxWidth: 'var(--maxw)', margin: '0 auto', padding: '0 var(--pad-x)' }}>
            <div className="cp-fade-up" style={{ maxWidth: 640, animation: 'cpFadeUp 0.7s ease both' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18, alignItems: 'center' }}>
                ...
                >
                  info@clearpointscientific.com <span className="cp-arrow">→</span>
                </a>
              </div>
            </div>
          </div>
        ...
        <div
          aria-hidden="true"
          style={{ position: 'absolute', left: 0, right: 0, bottom: 26, display: 'flex', justifyContent: 'center', pointerEvents: 'none' }}
        >
          <div className="cp-scrollcue" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 7 }}>
            <span
              style={{
                fontFamily: 'var(--font-mono)',
                fontSize: 10.5,
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="rgba(255,255,255,0.85)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
